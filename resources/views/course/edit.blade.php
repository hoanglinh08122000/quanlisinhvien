	...
	<div class="card-body card-block" >
		<form action="{{ route('course.process_update_course',['id'=>$course->id]) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="row form-group">
				...
				<div class="col-12 col-md-9"><input type="text" id="text-input" name="name_collapse" placeholder="Text" class="form-control" value="{{ $course->name_collapse }}"><small class="form-text text-muted">This is a help text</small></div>
			</div>
